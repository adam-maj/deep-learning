...
[^2]: Karl Friston's [Free Energy Principle](https://www.nature.com/articles/nrn2787) also suggests that this definition of intelligence is also valid in the context of the brain. (Beware, the concept is explained with unnecessary mathematical complexity, but it actually describes something relatively intuitive).
